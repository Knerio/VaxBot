...
public class Config {
    ...
    public static class Id {
        ...
        public enum Channel {
            ...
            RULE_CHANNEL,
            APPLY_CHANNEL,
            PROMOTE_CHANNEL, SUGGESTION_CREATE_CHANNEL, SUGGESTION_CHANNEL, SUGGESTION_ADMIN_CHANNEL, JOIN_CHANNEL, USER_COUNT_CHANNEL, SUPPORT_CHANNEL, TEAM_CHAT, FEEDBACK_CREATION_CHANNEL, FEEDBACK_ADMIN_CHANNEL, BOOST_CHANNEL, LOG_CHANNEL, STAFFLIST_CHANNEL
        }
