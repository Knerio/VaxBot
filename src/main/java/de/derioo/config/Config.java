...
public class Config {
    ...
    public static class Id {
        ...
        public enum Role {
            ...
            TIMEOUT_USER,
            WARN_USER,
            PLAYER_ROLE, SUPPORT_PING, RULE_ACCEPT_ROLES, LEVEL_50_ROLE, LEVEL_30_ROLE, LEVEL_20_ROLE, TWITCH_PING_ROLES, YOUTUBE_PING_ROLES, TIKTOK_PING_ROLES, ERROR_ROLE, GIVEAWAY_PING_ROLE
        }
