...
public class Config {
    ...
    public static class Id {
        ...
        public enum Channel {
            ...
            TICKET_LOGS_CHANNEL,
            ERROR_CHANNEL,
            PROMOTE_CHANNEL, SUGGESTION_CREATE_CHANNEL, SUGGESTION_CHANNEL, SUGGESTION_ADMIN_CHANNEL, STAFFLIST_CHANNEL
        }
        ...
        public enum Role {
            TICKET_EDIT,
            TICKET_MANAGE,
            REMOVE_USER_FROM_TICKET, TEAM_ADD, TEAM_ROLE, ADD_USER_TO_TICKET, GIVEAWAY_CREATE_ROLE, CLEAR, MOVE_ALL, BUG_REPORT_EDIT, BAN_USER, KICK_USER, TIMEOUT_USER, WARN_USER, GIVEAWAY_PING_ROLE
        }
