...
public class Config {
    ...
    public static class Id {
        ...
        public enum Channel {
            ...
            TICKET_LOGS_CHANNEL,
            ERROR_CHANNEL,
            PROMOTE_CHANNEL, SUGGESTION_CREATE_CHANNEL, SUGGESTION_CHANNEL, SUGGESTION_ADMIN_CHANNEL, JOIN_CHANNEL, USER_COUNT_CHANNEL, SUPPORT_CHANNEL, TEAM_CHAT, FEEDBACK_CREATION_CHANNEL, FEEDBACK_ADMIN_CHANNEL, BOOST_CHANNEL, STAFFLIST_CHANNEL
        }
        ...
        public enum Role {
            ...
            TIMEOUT_USER,
            WARN_USER,
            PLAYER_ROLE, SUPPORT_PING, GIVEAWAY_PING_ROLE
        }
