...
public class KickCommand {
    ...
    @Execute
    public void execute(@Arg("user") @Description("Der User der gekickt werden soll") User user, @Join("grund") @Description("Der Grund für den Kick") String reason, @Context SlashCommandInteractionEvent event) {
