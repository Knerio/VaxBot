...
public class BanCommand {
    ...
    @Execute
    public void execute(@Arg("user") @Description("Der User der gebannt werden soll") User user, @Join("grund") @Description("Der Grund für den Bann") String reason, @Context SlashCommandInteractionEvent event) {
